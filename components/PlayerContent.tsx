    ...
    return (
        <div className="grid grid-cols-2 md:grid-cols-3 h-full">
            ...
            <div className="hidden h-full md:flex items-center justify-center w-full max-w-[722px] gap-6">
                <AiFillStepBackward onClick={onPlayPrev} size={30} className="text-neutral-400 cursor-pointer hover:text-white
                transition
                " />
                <div onClick={handlePlay} className="flex items-center justify-center h-10 w-10 rounded-full bg-white p-1 cursor-pointer">
                    <Icon size={30} className="text-black" />
                </div>
                <AiFillStepForward onClick={onPlayNext} size={30} className="text-neutral-400 cursor-pointer hover:text-white
                transition
                " />
            </div>
            <div className="hiddem md:flex w-full justify-end pr-2">
